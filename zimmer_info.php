    ...
    <table class="tabelle">
        ...
        <td id="right">
            ...
            <div class="reviews-container">
                ...
                $sql ='SELECT k.Vorname AS Kunde, k.Vorname, b.Startdatum, b.Buchungs_ID, b.Enddatum, b.Details FROM buchungen b JOIN kunden k ON b.Kunden_ID = k.Kunden_ID WHERE b.Zimmer_Nummer = '.$zimmer_id.'; ';
                $result = $conn->query($sql);
