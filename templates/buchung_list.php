...
<body>
    ...
    <table class="table">
        ...
        <?php
            ...
            $sql = 
            "   SELECT b.Buchungs_ID, z.Zimmertyp, k.Vorname, k.Nachname, b.Startdatum, b.Enddatum, z.Preis_pro_Nacht,      -- Тут вроде правильно, но сверься еще раз --
                CASE                                                                                              --  Файл конфига: *** См. /db/init.sql *** --
